package com.mnp.twittersource.spouts;
...
public class TwitterSampleSpout extends BaseRichSpout{
	...
	public void nextTuple() {
		...
		if(ret==null || ret.getSource() == null) {
            Utils.sleep(50);
        } else {
            _collector.emit(new Values(ret.getText(),ret.getSource()));
        }
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		// TODO Auto-generated method stub
		 declarer.declare(new Fields("tweet","source"));
	}
}
