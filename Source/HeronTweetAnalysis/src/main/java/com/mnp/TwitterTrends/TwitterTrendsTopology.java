package com.mnp.TwitterTrends;

import java.util.LinkedList;
import java.util.Map;

import com.google.common.collect.ImmutableList;
import com.mnp.TwitterTrends.bolt.ExtractHashtagsBolt;
import com.mnp.TwitterTrends.bolt.ExtractMessageBolt;
import com.mnp.TwitterTrends.bolt.IntermediateRankingsBolt;
import com.mnp.TwitterTrends.bolt.RollingCountBolt;
import com.mnp.TwitterTrends.bolt.TotalRankingsBolt;
import com.mnp.TwitterTrends.spouts.TwitterSampleSpout;
...
public class TwitterTrendsTopology {
	...
	/* public static class StdoutBolt extends BaseRichBolt {
	 ...
	 public static void main(String[] args) throws Exception {
		    ...
		    conf.registerSerialization(DataGeneratorTrends.class);
		    conf.setDebug(true);
		    ...
		    if (args != null && args.length > 0) {
		      ...
		      cluster.submitTopology("Tweets", conf, builder.createTopology());
		    }
		  }
}
